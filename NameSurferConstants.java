...
/** The number of pixels from Top and from Bottom to the horizontal line*/
	public static final int BOTTOM_DIST = 15;
	
	public static final String NAMESDB="names-data.txt";
